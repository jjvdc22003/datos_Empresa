  ...
  <div id="base" class="">
        ...
        <div id="u34_state0_content" class="panel_state_content">
          ...
          <div id="u35" class="ax_default" data-left="0" data-top="478" data-width="680" data-height="207">
            ...
            <div id="u38" class="ax_default text_field">
              ...
              <input id="u38_input" type="text" value="" class="u38_input" style="color: rgb(153, 153, 153);">
            </div>

            <!-- Unnamed (Rectangle) TERMINADO-->
            <div id="u39" class="ax_default paragraph">
              <div id="u39_text" class="text ">
                <p><span>Nuestra compañía fue fundada en Monterrey, México, en 1906. Empezamos como una empresa local y,
                    gracias a nuestra visión, evolucionamos hasta convertirnos en una de las compañías globales líderes
                    en nuestra industria. Ahora contamos con el apoyo de cerca de 43 mil colaboradores en todo el mundo.
                    Mantenemos relaciones comerciales con más de cien países y una red de operaciones con más de
                    cincuenta naciones en la que se produce, distribuye y comercializa cemento, concreto premezclado,
                    agregados y productos relacionados.</span></p>
              </div>
            </div>
          </div>
          ...
          <div id="u40" class="ax_default" data-left="0" data-top="0" data-width="680" data-height="468">
            ...
            <div id="u49" class="ax_default text_field">
              ...
              <input id="u49_input" type="text" value="CEMEX" class="u49_input">
            </div>

            <!-- Unnamed (Text Field) TERMINADO -->
            <div id="u50" class="ax_default text_field">
              <div id="u50_div" class=""></div>
              <input id="u50_input" type="text" value="Santiago de Querétaro, Querétaro " class="u50_input">
            </div>

            <!-- Unnamed (Text Field) TERMINADO -->
            <div id="u51" class="ax_default text_field">
              <div id="u51_div" class=""></div>
              <input id="u51_input" type="text" value="Claudia Guadalupe Bustos Guerrero" class="u51_input">
            </div>

            <!-- Unnamed (Text Field) TERMINADO -->
            <div id="u52" class="ax_default text_field">
              <div id="u52_div" class=""></div>
              <input id="u52_input" type="text" value="Sttaffing y adquisición de talento / Recursos …"
                class="u52_input">
            </div>
            ...
            <div id="u53" class="ax_default text_field">
              ...
              <input id="u53_input" type="text" value="52 442 3091600 / Ext. 5007" class="u53_input">
            </div>

            <!-- Unnamed (Text Field) TERMINADO -->
            <div id="u54" class="ax_default text_field">
              <div id="u54_div" class=""></div>
              <input id="u54_input" type="text" value="claudia.bustos@cemex.com" class="u54_input">
            </div>
            ...
            <div id="u57" class="ax_default text_field">
              ...
              <input id="u57_input" type="text" value="cemex@cemex.com.mx" class="u57_input">
            </div>

            <!-- Unnamed (Text Field) TERMINADO -->
            <div id="u58" class="ax_default text_field">
              <div id="u58_div" class=""></div>
              <input id="u58_input" type="text" value="442 3091600" class="u58_input">
            </div>
          ...
          <div id="u66" class="ax_default text_field">
            ...
            <input id="u66_input" type="text" value="Ciudad" class="u66_input">
          </div>

          <!-- Unnamed (Text Field) TERMINADO -->
          <div id="u67" class="ax_default text_field">
            <div id="u67_div" class=""></div>
            <input id="u67_input" type="text" value="Estado" class="u67_input">
          </div>

          <!-- Unnamed (Text Field) TERMINADO -->
          <div id="u68" class="ax_default text_field">
            <div id="u68_div" class=""></div>
            <input id="u68_input" type="text" value="C.P." class="u68_input">
          </div>

          <!-- Unnamed (Text Field) TERMINADO -->
          <div id="u69" class="ax_default text_field">
            <div id="u69_div" class=""></div>
            <input id="u69_input" type="text" value="Calle" class="u69_input">
          </div>

          <!-- Unnamed (Text Field) TERMINADO -->
          <div id="u70" class="ax_default text_field">
            <div id="u70_div" class=""></div>
            <input id="u70_input" type="text" value="Número/Piso" class="u70_input">
          </div>

          <!-- Unnamed (Text Field) TERMINADO -->
          <div id="u71" class="ax_default text_field">
            <div id="u71_div" class=""></div>
            <input id="u71_input" type="text" value="Colonia" class="u71_input">
          </div>

          <!-- Unnamed (Text Field) TERMINADO -->
          <div id="u72" class="ax_default text_field">
            <div id="u72_div" class=""></div>
            <input id="u72_input" type="text" value="Ingrese RFC de la empresa..." class="u72_input">
          </div>

          <!-- Unnamed (Text Field) TERMINADO -->
          <div id="u73" class="ax_default text_field">
            <div id="u73_div" class=""></div>
            <input id="u73_input" type="text" value="Página web de la empresa..." class="u73_input">
          </div>
    ...
    <div id="u85" class="ax_default button" style="cursor: pointer;">
      ...
      <div id="u85_text" class="text ">
        <p><span>Editar datos de la empresa</span></p>
      </div>
    </div>
  </div>
</body>
