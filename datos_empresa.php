<?php
    ...
    $correo_electronico_empresa="cemex@cemex.com.mx";
    $telefono_empresa="442 3091600";
    $ubicacion_empresa="Santiago de Querétaro, Querétaro";
    
    //Datos del contacto
    $contacto_directo="Claudia Guadalupe Bustos Guerrero";
    $area_contacto="Sttaffing y adquisición de talento / Recursos …";
    $telefono_contacto="52 442 3091600 / Ext. 5007";
    $correo_electronico_contacto="claudia.bustos@cemex.com";

    //Descripción de la empresa
    $descripcion_empresa="Nuestra compañía fue fundada en Monterrey, México, en 1906. Empezamos como una empresa local y, gracias a nuestra visión, evolucionamos hasta convertirnos en una de las compañías globales líderes en nuestra industria. Ahora contamos con el apoyo de cerca de 43 mil colaboradores en todo el mundo. Mantenemos relaciones comerciales con más de cien países y una red de operaciones con más de cincuenta naciones en la que se produce, distribuye y comercializa cemento, concreto premezclado, agregados y productos relacionados.";
    ...
    <div id="base" class="">
        ...
        <div id="u34_state0" class="panel_state" data-label="State1">
            ...
            <div id="u40" class="ax_default" data-left="0" data-top="0" data-width="680" data-height="468">
                ...
                <input id="u54_input" type="text" value="<?php echo $correo_electronico_contacto; ?>" class="u54_input" disabled>
                </div>
                ...
                <input id="u57_input" type="text" value="<?php echo $correo_electronico_empresa; ?>" class="u57_input" disabled>
                </div>
